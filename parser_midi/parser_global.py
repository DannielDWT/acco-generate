...
def load_acco_dict(acco_grammars):
    '''
    :param acco_grammars:
    list类型，伴奏轨的一个长字符串
    :return:
    ...
    acco_val_indices =  dict((v, i) for i, v in enumerate(acco_values))
    acco_indices_val = dict((i, v) for i, v in enumerate(acco_values))
    return acco_corpus, acco_values, acco_val_indices, acco_indices_val

def load_melody_dict(melody_grammars):
    '''
    ...
    melody_val_indices = dict((v, i) for i, v in enumerate(melody_values))
    melody_indices_val = dict((i, v) for i, v in enumerate(melody_values))
    return melody_corpus, melody_values, melody_val_indices, melody_indices_val

#----------------------------SECOND VERSION FUNCTIONS----------------------------------#

def load_acco_dict_improved(acco_grammars):
    '''
    :param acco_grammars:
    list类型，伴奏轨的一个长字符串
    :return:
